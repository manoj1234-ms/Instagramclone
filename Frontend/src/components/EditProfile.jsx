...
import { setAuthUser } from '../redux/authSlice'; // Corrected import statement
...
const EditProfile = () => {
    ...
    const editProfileHandler = async () => {
        ...
        try {
            setLoading(true);
            const res = await axios.post('https://instagram-clone1-gxi0.onrender.com/api/v1/user/profile/edit', formData, {
                headers: {
